...
public class InsertarAvionView extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Insertar Avión");

        jLabel4.setText("Insertar Tipo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Avion avionNuevo = new Avion(codigo, nombre);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InsertarAvionView dialog = new InsertarAvionView(new javax.swing.JFrame(), true);
