...
public class BorrarPiloto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Borrar Piloto por ID");

        jLabel2.setText("Introducir ID del Piloto");
    ...
    private void borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarActionPerformed
        ...
        Long idPiloto = Long.parseLong(idText.getText());

        // Crea una instancia de PilotoDAO
        HibernateUtil hUtil = new HibernateUtil();
        PilotoDAO pilotoDAO = new PilotoDAO(hUtil.getSessionFactory());

        // Llama al método para borrar el piloto
        pilotoDAO.eliminarPilotoPorId(idPiloto);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarPiloto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BorrarPiloto dialog = new BorrarPiloto(new javax.swing.JFrame(), true);
