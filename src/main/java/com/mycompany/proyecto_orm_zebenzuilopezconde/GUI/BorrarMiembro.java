...
public class BorrarMiembro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Borrar Miembro por ID");

        jLabel2.setText("Introducir ID del Miembro");
    ...
    private void borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarActionPerformed
        ...
        Long idMiembro = Long.parseLong(idText.getText());

        // Crea una instancia de MiembroDAO
        HibernateUtil hUtil = new HibernateUtil();
        MiembroDAO miembroDAO = new MiembroDAO(hUtil.getSessionFactory());

        // Llama al método para borrar el miembro
        miembroDAO.eliminarMiembroPorId(idMiembro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarMiembro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BorrarMiembro dialog = new BorrarMiembro(new javax.swing.JFrame(), true);
